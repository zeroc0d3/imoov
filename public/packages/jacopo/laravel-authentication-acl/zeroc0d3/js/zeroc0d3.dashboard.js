var ZeroC0D3Dashboard = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            ZeroC0D3Dashboard.counterOverview();
            ZeroC0D3Dashboard.callModal1();
            ZeroC0D3Dashboard.weatherIcons();
            ZeroC0D3Dashboard.gritterNotification();
            ZeroC0D3Dashboard.visitorChart();
            ZeroC0D3Dashboard.realtimeStatusChart();
            ZeroC0D3Dashboard.countNumber();
            ZeroC0D3Dashboard.dropzone();
        },
            ...
            var tour = new Tour({
                ...
                onEnd: function (tour) {
                    ...
                    $('#modal-bootstrap-tour-end').on('hide.bs.modal', function () {
                        ZeroC0D3Dashboard.sessionTimeout();
                    });
                },
