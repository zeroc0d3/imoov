var ZeroC0D3Login = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            ZeroC0D3Login.signBaseURL();
            ZeroC0D3Login.signIE();
            ZeroC0D3Login.signSound();
            ZeroC0D3Login.signValidation();
            ZeroC0D3Login.signSettingHeight();
            ZeroC0D3Login.signInputSound();
        },
        ...
        signSound: function () {
            if($('.page-sound').length){
                ion.sound({
                    ...
                    path: ZeroC0D3Login.signBaseURL()+'/assets/global/plugins/bower_components/ionsound/sounds/',
                    preload: true
                });
            }
        },
