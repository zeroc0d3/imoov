var ZeroC0D3ChgPassword = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            ZeroC0D3ChgPassword.signBaseURL();
            ZeroC0D3ChgPassword.signIE();
            ZeroC0D3ChgPassword.signSound();
            ZeroC0D3ChgPassword.signValidation();
            ZeroC0D3ChgPassword.signSettingHeight();
            ZeroC0D3ChgPassword.signInputSound();
        },
        ...
        signSound: function () {
            if($('.page-sound').length){
                ion.sound({
                    ...
                    path: ZeroC0D3ChgPassword.signBaseURL()+'/assets/global/plugins/bower_components/ionsound/sounds/',
                    preload: true
                });
            }
        },
