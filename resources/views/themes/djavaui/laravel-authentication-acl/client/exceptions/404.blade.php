...
<div class="error-wrapper">
    ...
    <h4>The page you are looking for might have been removed, or unavailable. <br> <br/> Go back to <a href="{!! URL::to('/') !!}"><i class="fa fa-home"></i> homepage</a> or maybe you could try a search:</h4>
